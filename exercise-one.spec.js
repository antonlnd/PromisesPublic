...
describe('exercise one (involving poem one)', function () {
	...
	describe('problemE', function () {
		...
		it('reads and logs the third THEN reads and logs the fourth stanza; if an error occurs only logs the error and does not continue reading (if there is a file still left to read)', function (done) {
			exercise.problemE();
			setTimeout(function () {
	...
	describe('problemF', function () {
		...
		it('reads and logs the third THEN reads and logs the fourth stanza; if an error occrus only logs the error and does not continue reading (if there is a file still left to read); always finishes by logging some done message', function (done) {
			exercise.problemF();
			setTimeout(function () {
